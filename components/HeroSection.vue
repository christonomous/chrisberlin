      ...
      <div class="max-w-3xl">
        ...
        <div class="flex justify-center gap-4">
          ...
          <div class="flex gap-3">
            <a href="https://twitter.com/chrisberlindev" target="_blank" class="btn btn-circle btn-gradient">
            ...
            <a href="https://github.com/chrisberlin" target="_blank" class="btn btn-circle btn-gradient">
            ...
            <a href="https://linkedin.com/in/chrisberlin" target="_blank" class="btn btn-circle btn-gradient">
