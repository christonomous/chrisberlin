    ...
    <div class="hero-content text-center flex flex-col">
      ...
      <div class="max-w-3xl">
        ...
        <div class="flex justify-center gap-4">
          <button class="btn btn-primary btn-lg">Explore My Work</button>
          <div class="flex gap-3">
            <a href="https://twitter.com/chrisberlindev" target="_blank" class="btn btn-circle btn-outline hover:btn-primary">
            ...
            <a href="https://github.com/chrisberlin" target="_blank" class="btn btn-circle btn-outline hover:btn-primary">
