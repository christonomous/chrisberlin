    ...
    <div class="container mx-auto px-4">
      <div class="max-w-4xl mx-auto space-y-12">
        ...
        <div class="flex justify-center gap-4">
          <a href="https://twitter.com/chrisberlindev" target="_blank" class="btn btn-circle btn-lg btn-outline hover:btn-primary">
          ...
          <a href="https://github.com/chrisberlin" target="_blank" class="btn btn-circle btn-lg btn-outline hover:btn-primary">
          ...
          <a href="https://linkedin.com/in/chrisberlin" target="_blank" class="btn btn-circle btn-lg btn-outline hover:btn-primary">
