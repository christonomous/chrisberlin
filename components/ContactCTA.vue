    ...
    <div class="container mx-auto px-4">
      <div class="max-w-4xl mx-auto space-y-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
              ...
              <button class="btn btn-gradient">Book a Session</button>
            </div>
          </div>
        ...
        <div class="flex justify-center gap-4">
          <a href="https://twitter.com/chrisberlindev" target="_blank" class="btn btn-circle btn-lg btn-gradient">
          ...
          <a href="https://github.com/chrisberlin" target="_blank" class="btn btn-circle btn-lg btn-gradient">
          ...
          <a href="https://linkedin.com/in/chrisberlin" target="_blank" class="btn btn-circle btn-lg btn-gradient">
