      ...
      <div class="container mx-auto max-w-6xl px-4 pt-12 md:pt-20 grid md:grid-cols-[1.1fr,0.9fr] gap-10 items-center">
        <div>
          ...
          <div class="mt-6 text-sm opacity-70">
            <span class="inline-flex items-center gap-2">Chat with my AI Agents, if you want to find out how you can get your time back</span>
          </div>
        </div>
      ...
      <div class="card bg-base-200/50 shadow-xl border border-base-300/30">
        <div class="card-body grid md:grid-cols-3 gap-6">
          <div>
            ...
            <p class="opacity-80">I identify a high‑leverage for you, so you can <span class="font-semibold">make the most out of your time</span>.</p>
          </div>
      ...
      <ul class="steps steps-vertical lg:steps-horizontal w-full mb-12 text-center" data-aos="fade-up" data-aos-delay="200">
        ...
        <li class="step step-secondary">
          <div class="flex flex-col items-center">
            ...
            <span class="text-sm text-base-content/80">AI SaaS</span>
          </div>
        </li>
        <li class="step">
          <div class="flex flex-col items-center">
